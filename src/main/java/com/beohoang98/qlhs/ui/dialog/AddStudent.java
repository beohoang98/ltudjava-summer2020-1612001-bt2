...
public class AddStudent extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        mssvField.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        mssvField.setPreferredSize(new java.awt.Dimension(100, 32));
        jPanel2.add(mssvField);

        loading.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/ajax-loader.gif"))); // NOI18N
        loading.setOpaque(true);
        jPanel2.add(loading);

        searchBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-search-24.png"))); // NOI18N
