...
public class CourseDetails extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(nameText, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addStudentActionPerformed
        AddStudent addStudentDialog = new AddStudent((Frame) SwingUtilities.getWindowAncestor(this), true);
    ...
    void addStudent(@NotNull Student student) {
        if (currentCourse != null) {
            student.getCourseSchedules().add(currentCourse);
    ...
    void loadStudent(String classCode) {
        Observable.fromCallable(() -> ScheduleService.instance.findByClassCourse(classCode, courseCode))
            .subscribeOn(Schedulers.io())
            .observeOn(Schedulers.single())
            .map(schedule -> schedule.getStudents())
